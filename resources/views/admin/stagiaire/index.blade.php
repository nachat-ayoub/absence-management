...
<x-app-layout>
    ...
    <div class="container mx-auto">
        ...
        <div class="overflow-x-auto">
            <table class="my-2 min-w-full table-auto divide-y divide-gray-200 px-2 py-1 dark:text-gray-100 md:px-6 md:py-3">
                <thead>
                    <tr>
                            ...
                            <td class="whitespace-nowrap px-3 py-2 text-sm font-medium text-gray-900 dark:bg-gray-800 dark:text-gray-100 md:px-2 md:py-1">{{ $stagiaire->prenom }}</td>
                               <td class="whitespace-nowrap px-3 py-2 text-lg font-medium dark:bg-gray-800 dark:text-gray-100 md:px-2 md:py-1">
                                   <div class="flex  space-y-2 md:flex-row md:space-y-0 md:space-x-4">
                                    <a class="text-lg mt-2 md:mt-0" href="{{ route('admin.showStagiaire', $stagiaire->id) }}">
                                    <div
