    ...
    <div class="container mx-auto mb-10 mt-10 px-4">
        ...
        <div class="w-full rounded-lg border border-gray-200 bg-white p-6 shadow dark:border-gray-700 dark:bg-gray-800">
            <div class="flex justify-start">
                <p class=" text-center mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                    #{{ $classe->id }}
                </p>
                <p class=" mx-24 text-center mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                    Brabche : {{ $classe->branche }}
                </p>
            </div>
            <div>
                <p class="mb-3 text-md font-medium text-gray-900 dark:text-gray-400">
                    Numero Group : {{ $classe->num_group }}
                </p>
                <p class="mb-3 text-md font-medium text-gray-900 dark:text-gray-400">
            ...
            <div class="overflow-x-auto my-4">
                <table class="w-full  text-md text-left text-gray-900 dark:text-gray-300">
                    ...
                    <tr>
                        <td class="whitespace-nowrap px-3 py-2 text-md font-medium text-gray-900 dark:bg-gray-800 dark:text-gray-100 md:px-2 md:py-1">{{$stagiaire->id}}</td>
            ...
            <div class="mt-6 ml-8 flex flex-row gap-4">
