                            ...
                            <td
                                ...
                                <div class="flex flex-row space-y-2 md:space-y-0 md:space-x-4">
                                    ...
                                    <a class="mt-2 text-lg md:mt-0"
                                        href="{{ route('admin.showFormateur', $formateur->id) }}">
...
<script>
    ...
    input.onkeydown = function() {
        ...
        for (var i = 0; i < data.length; i++) {
            if (data[i].nom.toLowerCase().includes(inputValue) || data[i].prenom.toLowerCase().includes(
                inputValue) || data[i].email.toLowerCase().includes(inputValue)) {
