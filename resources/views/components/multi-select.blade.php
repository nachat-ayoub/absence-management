        ...
        <div class="inline-block relative w-full">
            <div class="flex flex-col items-center relative">
                <div x-on:click="open" class="w-full  svelte-1l8159u">
                    <div class="my-2 p-1 flex border border-gray-300 bg-white dark:bg-gray-900 dark:border-gray-700 shadow-sm rounded svelte-1l8159u" x-bind:class="{'p-0.5 ring-1 border-indigo-500 dark:border-indigo-600 ring-indigo-500 dark:ring-indigo-600' : isOpen()  }">
                        ...
                        <div class="flex flex-auto flex-wrap">
                            ...
                            <div x-show="selected.length    == 0" class="flex-1">
                                <input placeholder="Selectioner les classes"
                                    class="bg-transparent p-1 px-2 appearance-none outline-none h-full w-full text-gray-800 placeholder:text-gray-700"
                                    x-bind:value="selectedValues()"
                                >
                            </div>
                        </div>
                        <div
                            class="text-gray-300 w-8 py-1 pl-2 pr-1 border-l flex items-center border-gray-300 dark:border-gray-700 svelte-1l8159u">
